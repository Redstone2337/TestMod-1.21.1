...
public class ModItemGroups {
    ...
    public static void register() {
        Registry.register(Registries.ITEM_GROUP,ModItemGroups.MOD_ITEMS,
                ItemGroup.create(
                                ItemGroup.Row.TOP, 0)
                        .displayName(Text.translatable("itemGroup.tmb.mod_items"))
        ...
        Registry.register(Registries.ITEM_GROUP,ModItemGroups.MOD_WEAPONS,
                ItemGroup.create(
                        ...
                        .displayName(Text.translatable("itemGroup.tmb.mod_weapons"))
        ...
        TestMod.LOGGER.info("Registered Item Groups");
    }
}
